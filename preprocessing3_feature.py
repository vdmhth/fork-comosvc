...
def process_one(filename, hmodel, mel_extractor, device, hop_length, sampling_rate, filter_length, win_length):
...
def process_batch(file_chunk, hop_length, sampling_rate, filter_length, win_length, device="cpu"):
    ...
    for filename in tqdm(file_chunk, position = rank):
        process_one(filename, hmodel, mel_extractor, device, hop_length, sampling_rate, filter_length, win_length)
...
if __name__ == "__main__":
    ...
    filenames = glob("./dataset/*/*.wav", recursive=True)
    shuffle(filenames)
